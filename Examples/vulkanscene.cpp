...
*
* ================================================================
* Adapted for SPOUT sending : http://spout.zeal.co/
...
public:
	...
	VulkanExample() : VulkanExampleBase()
	{
		...
		sender.SetSenderName("Vulkan Demo Scene");
	...
	~VulkanExample()
	{
		...
		// DirectX11 is closed in the SpoutVK destructor
	...
	void buildCommandBuffer() {
		...
		//
		sender.SendImage(physicalDevice, device, cmdBuffer,
